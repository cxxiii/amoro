...
public class TableProperties {
  ...
  public static final String SELF_OPTIMIZING_MAX_COMMIT_FILE_CNT = "self-optimizing.max-commit-file-count";
  public static final int SELF_OPTIMIZING_MAX_COMMIT_FILE_CNT_DEFAULT = 20;
